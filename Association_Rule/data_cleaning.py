...
for year in range(2016,2018):
    for e in range(2):
        ...
        if e == 1:
            ...
            utilities = set(["AES","LNT","AEE","AEP","AWK","ATO","CNP","CMS","ED","D","DTE","DUK","EIX","ETR","ES","EXC","FE","NEE","NI","NRG","PNW","PPL","PEG","SRE","SO","WEC","XEL"])
            energy = set(["APA","BKR","COG","CVX","CXO","COP","DVN","FANG","EOG","XOM","HAL","HP","HES","HFC","KMI","MRO","MPC","NOV","NBL","OXY","OKE","PSX","PXD","SCG","SLB","FTI","VLO","WMB"])
        ...
        interest = interest.withColumn('antecedent', concat_ws(',','antecedent')).withColumn('consequent',concat_ws(',','consequent'))
